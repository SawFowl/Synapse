...
public class IConfigurationService implements ConfigurationService {
	...
	/*private libs.localeapi.geysermc.yaml.YamlConfigurationLoader.Builder createGeyserYamlConfigurationLoader(@Nullable TypeSerializerCollection otherSerializers) {
		return libs.localeapi.geysermc.yaml.YamlConfigurationLoader.builder().defaultOptions(options -> options.serializers(otherSerializers == null ? DEFAULT : mergeSerializers(DEFAULT, otherSerializers))).nodeStyle(libs.localeapi.geysermc.yaml.NodeStyle.BLOCK);
	}*/
